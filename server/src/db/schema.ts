...
export const transactions = pgTable(
  'transactions',
  {
    // Payment hash (32-byte hex string)
    // This is generated by the Lightning Network and identifies the payment
    // Combined with transactionType to form composite primary key
  ...
  (table) => {
    ...
    return {
      // Composite primary key: payment_hash + transaction_type
      // This allows both invoice and payment records for the same payment
      pk: primaryKey({ columns: [table.paymentHash, table.transactionType] }),
